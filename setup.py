...
if version_info[0] >= 3:
    setup(
        test_suite="test",
        tests_require=["mock" + ("<4" if version_info < (3, 6) else "")],
    )
    ...
    setup(
        ...
        packages=find_packages(
            exclude=["ez_setup", "examples", "test", "django_tests", "django_tests.*"]
        ),
        classifiers=[
        ...
        zip_safe=False,
        test_suite="test",
        install_requires=["six", "urllib3>=1.26.5", "certifi"],
        tests_require=["mock<4"],
    )
