...
def create_sub_account(name, **options):
    uri = ['sub_accounts']
    return call_api("post", uri, {"name": name, **_only(options, "cloud_name", "base_sub_account_id", "description")}, **options)
...
def update_sub_account(sub_account_id, **options):
    uri = ['sub_accounts', sub_account_id]
    return call_api("put", uri, _only(options, "cloud_name", "description", "base_sub_account_id", "enabled"), **options)
