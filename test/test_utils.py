...
class TestUtils(unittest.TestCase):
    ...
    custom_function_remote_str = "remote:aHR0cHM6Ly9kZjM0cmE0YS5leGVjdXRlLWFwaS51cy13ZXN0LTIuYW1hem9uYXdzLmNvbS9kZWZhdWx0L2Nsb3VkaW5hcnlGbg=="
    ...
    def __test_cloudinary_url(
        self, public_id=TEST_ID, options=None, expected_url=None, expected_options=None
    ):
    ...
    def test_cloud_name(self):
        ...
        self.__test_cloudinary_url(
            options={}, expected_url=DEFAULT_UPLOAD_PATH + "test"
        )
    ...
    def test_format(self):
        ...
        self.__test_cloudinary_url(
            options={"format": "jpg"}, expected_url=DEFAULT_UPLOAD_PATH + "test.jpg"
        )
    ...
    def test_various_options(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "g_center,o_20,p_a,q_0.4,r_3,x_1,y_2/test",
        )
        self.__test_cloudinary_url(
            options={"gravity": "auto", "width": 0.5, "crop": "crop"},
    ...
    def test_radius(self):
        cases = (
            ...
            ({"radius": "10:20:30:40"}, "r_10:20:30:40"),
            (
                {"radius": "10:$v:30:40", "variables": [("$v", 20)]},
                "$v_20,r_10:$v:30:40",
            ),
        )
        for options, expected_part_url in cases:
            self.__test_cloudinary_url(
                options=options,
                expected_url=DEFAULT_UPLOAD_PATH + expected_part_url + "/test",
            )
    ...
    def test_should_support_auto_width(self):
        ...
        self.__test_cloudinary_url(
            options={"width": "auto:20", "crop": "fill"},
        ...
        self.__test_cloudinary_url(
            options={"width": "auto:breakpoints", "crop": "fill"},
            expected_url=DEFAULT_UPLOAD_PATH + "c_fill,w_auto:breakpoints/test",
            expected_options={"responsive": True},
        )
        self.__test_cloudinary_url(
            options={"width": "auto:breakpoints_100_1900_20_15", "crop": "fill"},
            expected_url=DEFAULT_UPLOAD_PATH
            + "c_fill,w_auto:breakpoints_100_1900_20_15/test",
            expected_options={"responsive": True},
        )
        self.__test_cloudinary_url(
            options={"width": "auto:breakpoints:json", "crop": "fill"},
    ...
    def test_original_width_and_height(self):
        ...
        self.__test_cloudinary_url(
            options={"crop": "crop", "width": "ow", "height": "oh"},
    ...
    def test_should_support_auto_value(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "g_center,p_a,q_auto:good,r_3,x_1,y_2/test",
        )
        self.__test_cloudinary_url(
            options={
                "width": 100,
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "c_crop,g_auto:ocr_text,h_100,w_100/test",
            expected_options={"width": 100, "height": 100},
        )
        self.__test_cloudinary_url(
            options={
        ...
        self.__test_cloudinary_url(
            options={
                ...
                "height": 100,
                "crop": "crop",
                "gravity": "ocr_text:adv_ocr",
            },
            expected_url=DEFAULT_UPLOAD_PATH
            + "c_crop,g_ocr_text:adv_ocr,h_100,w_100/test",
            expected_options={"width": 100, "height": 100},
        )
    ...
    def test_transformation_simple(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH + "t_blip/test",
        )
    ...
    def test_base_transformation_array(self):
        ...
        self.assertEqual(
            result,
            DEFAULT_UPLOAD_PATH + "c_fill,w_200,x_100,y_100/r_10/c_crop,w_100/test",
        )
    ...
    def test_raw_transformation(self):
        ...
        self.__test_cloudinary_url(
            options={
                "transformation": {"width": 100, "raw_transformation": "g_north_west"}
            },
            expected_url=DEFAULT_UPLOAD_PATH + "w_100,g_north_west/test",
        )
        self.__test_cloudinary_url(
            options={"transformation": {"raw_transformation": "g_north_west"}},
            expected_url=DEFAULT_UPLOAD_PATH + "g_north_west/test",
        )
        self.__test_cloudinary_url(
            options={"transformation": {"width": 100, "raw_transformation": ""}},
    ...
    def test_chain_transformations(self):
        ...
        actual_options = chain_transformations(
            dict(width=200, height=100), chained_transformations
        )
        ...
        self.assertEqual(
            "e_art:incognito,f_png/c_fill,w_200,x_100,y_100/r_10/"
            + self.raw_transformation,
            actual_transformation_str,
        )
        ...
        self.assertEqual(
            "e_art:incognito,f_gif/c_fill,w_200,x_100,y_100/r_10/"
            + self.raw_transformation,
            actual_transformation_str,
        )
    ...
    def test_type(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_ROOT_PATH + "image/facebook/test",
        )
    ...
    def test_resource_type(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_ROOT_PATH + "raw/upload/test",
        )
    ...
    def test_fetch(self):
        ...
        options = {"type": "fetch"}
        result, options = cloudinary.utils.cloudinary_url(
            "http://blah.com/hello?a=b", **options
        )
        self.assertEqual(options, {})
        self.assertEqual(
            result, DEFAULT_ROOT_PATH + "image/fetch/http://blah.com/hello%3Fa%3Db"
        )
    ...
    def test_http_escape(self):
        ...
        result, options = cloudinary.utils.cloudinary_url(
            "http://www.youtube.com/watch?v=d9NF2edxy-M", **options
        )
        self.assertEqual(options, {})
        self.assertEqual(
            result,
            DEFAULT_ROOT_PATH
            + "image/youtube/http://www.youtube.com/watch%3Fv%3Dd9NF2edxy-M",
        )
    ...
    def test_background(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH + "b_red/test",
        )
        self.__test_cloudinary_url(
    ...
    def test_angle(self):
        ...
        self.__test_cloudinary_url(
            options={"angle": 12}, expected_url=DEFAULT_UPLOAD_PATH + "a_12/test"
        )
    ...
    def test_overlay(self):
        ...
        self.__test_cloudinary_url(
            options={
                "overlay": {"font_family": "arial", "font_size": 20, "text": "hello"},
                "height": 100,
                "width": 100,
            },
            expected_url=DEFAULT_UPLOAD_PATH + "h_100,l_text:arial_20:hello,w_100/test",
        )
    ...
    def test_custom_function(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "fn_"
            + self.custom_function_remote_str
            + "/test",
        )
    ...
    def test_effect(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH + "e_sepia/test",
        )
    ...
    def test_keyframe_interval(self):
        ...
        for value, expected in test_values:
            self.__test_cloudinary_url(
                options={"resource_type": "video", "keyframe_interval": value},
    ...
    def test_streaming_profile(self):
        ...
        self.__test_cloudinary_url(
            options={"streaming_profile": "some-profile"},
    ...
    def test_density(self):
        ...
        self.__test_cloudinary_url(
            options={"density": 150}, expected_url=DEFAULT_UPLOAD_PATH + "dn_150/test"
        )

    def test_page(self):
        """should support page"""
        self.__test_cloudinary_url(
            options={"page": 3}, expected_url=DEFAULT_UPLOAD_PATH + "pg_3/test"
        )
    ...
    def test_flags(self):
        ...
        self.__test_cloudinary_url(
            options={"flags": "abc"}, expected_url=DEFAULT_UPLOAD_PATH + "fl_abc/test"
        )
        self.__test_cloudinary_url(
    ...
    def test_dpr(self):
        ...
        self.__test_cloudinary_url(
            options={"dpr": "2.0"}, expected_url=DEFAULT_UPLOAD_PATH + "dpr_2.0/test"
        )

    def test_folder_version(self):
        """should add version if public_id contains /"""
        self.__test_cloudinary_url(
            public_id="folder/test", expected_url=DEFAULT_UPLOAD_PATH + "v1/folder/test"
        )
        self.__test_cloudinary_url(
        ...
        self.__test_cloudinary_url(
            public_id="v1234/test", expected_url=DEFAULT_UPLOAD_PATH + "v1234/test"
        )
    ...
    def test_force_version(self):
        ...
        self.__test_cloudinary_url(
            TEST_FOLDER, expected_url=DEFAULT_UPLOAD_PATH + TEST_FOLDER
        )
    ...
    def test_shorten(self):
        self.__test_cloudinary_url(
            options={"shorten": True}, expected_url=DEFAULT_ROOT_PATH + "iu/test"
        )
        self.__test_cloudinary_url(
            options={"shorten": True, "type": "private"},
    ...
    def test_signed_url(self):
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "s--Ai4Znfl3--/c_crop,h_20,w_10/v1234/image.jpg",
        )
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_UPLOAD_PATH
            + "s--Ai4Znfl3--/c_crop,h_20,w_10/image.jpg",
        )
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_ROOT_PATH
            + "image/authenticated/s--Ai4Znfl3--/c_crop,h_20,w_10/image.jpg",
        )
        ...
        self.__test_cloudinary_url(
            ...
            expected_url=DEFAULT_ROOT_PATH
            + "image/fetch/s--hH_YcbiS--/v1234/http://google.com/path/to/image.png",
        )
    ...
    def test_disallow_url_suffix_in_non_upload_types(self):
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", url_suffix="hello", private_cdn=True, type="facebook"
            )

    def test_disallow_url_suffix_with_slash_or_dot(self):
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", url_suffix="hello/world", private_cdn=True
            )
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", url_suffix="hello.world", private_cdn=True
    ...
    def test_not_sign_the_url_suffix(self):
        ...
        self.__test_cloudinary_url(
            ...
            expected_url="http://test123-res.cloudinary.com/images/"
            + expected_signature.group(0)
            + "/test/hello.jpg",
        )

        url, options = cloudinary.utils.cloudinary_url(
            "test", format="jpg", angle=0, sign_url=True
        )
        expected_signature = re.search(r"s--[0-9A-Za-z_-]{8}--", url)
        self.__test_cloudinary_url(
            options={
    ...
    def test_support_use_root_path_for_shared_cdn(self):
        self.__test_cloudinary_url(
            options={"use_root_path": True, "private_cdn": False},
            expected_url=DEFAULT_ROOT_PATH + "test",
        )
        self.__test_cloudinary_url(
            options={"use_root_path": True, "private_cdn": False, "angle": 0},
            expected_url=DEFAULT_ROOT_PATH + "a_0/test",
        )

    def test_support_use_root_path_for_private_cdn(self):
        self.__test_cloudinary_url(
            options={"use_root_path": True, "private_cdn": True},
            expected_url="http://test123-res.cloudinary.com/test",
        )
        self.__test_cloudinary_url(
            options={"use_root_path": True, "private_cdn": True, "angle": 0},
    ...
    def test_support_use_root_path_together_with_url_suffix_for_private_cdn(self):
        self.__test_cloudinary_url(
            options={"use_root_path": True, "url_suffix": "hello", "private_cdn": True},
    ...
    def test_disallow_use_root_path_if_not_image_upload(self):
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", use_root_path=True, private_cdn=True, type="facebook"
            )
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", use_root_path=True, private_cdn=True, resource_type="raw"
            )
    ...
    def test_escape_public_id_with_non_ascii_characters(self):
        self.__test_cloudinary_url("ß", expected_url=DEFAULT_UPLOAD_PATH + "%C3%9F")
    ...
    def test_responsive_width(self):
        ...
        self.assertEqual(
            result, DEFAULT_UPLOAD_PATH + "c_crop,h_100,w_100/c_limit,w_auto/test"
        )
        cloudinary.config(
            responsive_width_transformation={"width": "auto", "crop": "pad"}
        )
        options = {
            "width": 100,
            "height": 100,
        ...
        self.assertEqual(options, {"responsive": True})
        self.assertEqual(
            result, DEFAULT_UPLOAD_PATH + "c_crop,h_100,w_100/c_pad,w_auto/test"
        )
    ...
    def test_fps(self):
        ...
        for value, expected in fps_test_values:
            self.__test_cloudinary_url(
                public_id="video_id",
                options={"resource_type": "video", "fps": value},
    ...
    def test_video_codec(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "video_codec": "auto"},
    ...
    def test_audio_codec(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "audio_codec": "acc"},
    ...
    def test_audio_frequency(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "audio_frequency": 44100},
    ...
    def test_start_offset(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "start_offset": 2.63},
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "start_offset": "35p"},
            expected_url=VIDEO_UPLOAD_PATH + "so_35p/video_id",
        )
        # should support percents of the video length as "<number>%"
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "start_offset": "35%"},
            expected_url=VIDEO_UPLOAD_PATH + "so_35p/video_id",
        )
        # should support auto
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "start_offset": "auto"},
    ...
    def test_end_offset(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "end_offset": 2.63},
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "end_offset": "35p"},
            expected_url=VIDEO_UPLOAD_PATH + "eo_35p/video_id",
        )
        # should support percents of the video length as "<number>%"
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "end_offset": "35%"},
            expected_url=VIDEO_UPLOAD_PATH + "eo_35p/video_id",
        )
    ...
    def test_duration(self):
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "duration": 2.63},
        ...
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "duration": "35p"},
            expected_url=VIDEO_UPLOAD_PATH + "du_35p/video_id",
        )
        # should support percents of the video length as "<number>%"
        self.__test_cloudinary_url(
            public_id="video_id",
            options={"resource_type": "video", "duration": "35%"},
            expected_url=VIDEO_UPLOAD_PATH + "du_35p/video_id",
        )
    ...
    def test_user_agent(self):
        ...
        six.assertRegex(
            self, agent, r"^CloudinaryPython\/\d\.\d+\.\d+ \(.*; Python \d\.\d+\.\d+\)$"
        )
    ...
    def test_text_layer_style_identifier_variables(self):
        options = {
            "transformation": [
                ...
                {"overlay": {"text": "hello-world", "text_style": "$style"}},
            ]
        }
        ...
        self.assertEqual(
            DEFAULT_UPLOAD_PATH + "$style_!Arial_12!/l_text:$style:hello-world/sample",
            url,
        )
    ...
    def test_overlay_error_2(self):
        ...
        with self.assertRaises(ValueError):
            cloudinary.utils.cloudinary_url(
                "test", underlay=dict(resource_type="video")
            )
    ...
    def test_translate_if(self):
        ...
        condition = (
            "width = 0 && height != 0 || aspect_ratio < 0 && page_count > 0 "
    ...
    def test_pow_operator(self):
        ...
        normalized = cloudinary.utils.generate_transformation_string(**transformation)[
            0
        ]
        expected = "w_iw_pow_2"
    ...
    def test_transformation_with_complex_predefined_variables(self):
        ...
        expected = "$aheight_300,$mywidth_100/h_3_mul_ih_add_$aheight,w_3_add_$mywidth_mul_3_add_4_div_2_mul_iw_mul_$mywidth"
    ...
    def test_array_should_define_a_set_of_variables(self):
        ...
        self.assertEqual(
            "if_fc_gt_2,$z_5,$foo_$z_mul_2,c_scale,w_$foo_mul_200", transformation
        )
    ...
    def test_dollar_key_should_define_a_variable(self):
        ...
        self.assertEqual(
            "$foo_10/if_fc_gt_2/c_scale,w_$foo_mul_200_div_fc/if_end", transformation
        )
    ...
    def test_should_use_context_value_as_user_variables(self):
        ...
        self.assertIn(
            "$xpos_ctx:!x_pos!_to_f,$ypos_ctx:!y_pos!_to_f,c_crop,x_$xpos_mul_w,y_$ypos_mul_h",
            transformation,
        )
    ...
    def test_should_support_text_values(self):
        ...
        url, options = cloudinary.utils.cloudinary_url(public_id, **options)
        self.assertEqual(
            DEFAULT_UPLOAD_PATH + "$efname_!blur!,e_$efname:100/sample", url
        )
    ...
    def test_encode_context(self):
        ...
        self.assertEqual(
            'a=["b","c"]', cloudinary.utils.encode_context({"a": ["b", "c"]})
        )
        ...
        self.assertEqual(
            "a=!@#$%^&*()_+<>?,./",
            cloudinary.utils.encode_context({"a": "!@#$%^&*()_+<>?,./"}),
        )
        # check value escaping
        self.assertEqual(
            r"a=b\|\|\=|c=d\=a\=\|",
            cloudinary.utils.encode_context(
                OrderedDict((("a", "b||="), ("c", "d=a=|")))
            ),
        )
        # check fallback
    ...
    def test_json_encode(self):
        ...
        self.assertEqual(
            '{"t":"2019-02-22T16:20:57"}',
            json_encode({"t": datetime(2019, 2, 22, 16, 20, 57)}),
        )
    ...
    def test_encode_unicode_url(self):
        ...
        self.assertEqual("encoded", encode_unicode_url("encoded"))
    ...
    def test_cloudinary_scaled_url(self):
        ...
        self.assertEqual(
            "{p}f_{ff}/{t}/{fu}".format(
                p=DEFAULT_FETCH_PATH, ff=fetch_format, t=resp_trans, fu=FETCH_URL
            ),
            actual_url,
        )

        # With custom transformation
        actual_url = cloudinary_scaled_url(
            FETCH_URL, resp_w, self.crop_transformation, options
        )

        self.assertEqual(
            "{p}c_crop,f_{f},w_100/{t}/{fu}".format(
                p=DEFAULT_FETCH_PATH, f=image_format, t=resp_trans, fu=FETCH_URL
            ),
            actual_url,
        )
        ...
        self.assertEqual(
            "{p}e_{e},f_{ff}/{t}/{fu}".format(
                p=DEFAULT_FETCH_PATH,
                e=effect,
                ff=fetch_format,
                t=resp_trans,
                fu=FETCH_URL,
        ...
        self.assertEqual(
            "{p}e_{e},f_{ff},{rt}/{t}/{fu}".format(
                p=DEFAULT_FETCH_PATH,
                e=effect,
                ff=fetch_format,
                rt=self.raw_transformation,
                t=resp_trans,
                fu=FETCH_URL,
            ),
            actual_url,
    ...
    def test_build_eager(self):
        test_data = [
            [
                ...
                "{}|{}/jpg".format(
                    API_TEST_TRANS_SCALE100_STR, API_TEST_TRANS_SEPIA_STR
                ),
            ],
            [
            ...
            [
                ...
                [
                    {"transformation": [API_TEST_TRANS_SCALE100, API_TEST_TRANS_SEPIA]},
                    API_TEST_TRANS_SEPIA,
                ],
                "{}/{}|{}".format(
                    API_TEST_TRANS_SCALE100_STR,
            ...
            [
                ...
                (
                    [
                        dict(API_TEST_TRANS_SCALE100, **{"format": ""}),
                        API_TEST_TRANS_SEPIA,
                    ]
                ),
                "{}/|{}".format(API_TEST_TRANS_SCALE100_STR, API_TEST_TRANS_SEPIA_STR),
            ...
            [
                ...
                (
                    [
                        dict(API_TEST_TRANS_SCALE100, **{"format": None}),
                        API_TEST_TRANS_SEPIA,
                    ]
                ),
                "{}|{}".format(API_TEST_TRANS_SCALE100_STR, API_TEST_TRANS_SEPIA_STR),
    ...
    def test_compute_hash(self):
        self.assertEqual(
            "4de279c82056603e91aab3930a593b8b887d9e48",
        ...
        self.assertEqual(
            compute_hex_hash(original_value),
            compute_hex_hash(original_value),
    ...
    def test_verify_api_response_signature(self):
        ...
        with patch(
            "cloudinary.config", return_value=cloudinary.config(api_secret=API_SECRET)
        ):
            self.assertTrue(
                verify_api_response_signature(
                    public_id, test_version, api_response_signature
                ),
            ...
            self.assertFalse(
                verify_api_response_signature(
                    public_id, test_version + 1, api_response_signature
                ),
                "The response signature is invalid for the wrong version",
            )

        with patch(
            "cloudinary.config", return_value=cloudinary.config(api_secret=None)
        ):
    ...
    def test_verify_api_response_signature_sha256(self):
        ...
        api_response_signature = (
            "cc69ae4ed73303fbf4a55f2ae5fc7e34ad3a5c387724bfcde447a2957cacdfea"
        )
    ...
    def test_verify_notification_signature(self):
        ...
        with patch("time.time", return_value=MOCKED_NOW):
            ...
            with patch(
                "cloudinary.config",
                return_value=cloudinary.config(api_secret=API_SECRET),
            ):
                self.assertTrue(
                    verify_notification_signature(
                        body, valid_response_timestamp, signature, valid_for
                    ),
                    "{} valid for matching and not expired signature".format(
                        test_message_part
                    ),
                )
                ...
                self.assertFalse(
                    verify_notification_signature(
                        body, valid_response_timestamp, signature, valid_for - 1
                    ),
                    "{} invalid for matching but expired signature".format(
                        test_message_part
                    ),
                )
                ...
                self.assertFalse(
                    verify_notification_signature(
                        body, valid_response_timestamp, signature + "chars"
                    ),
                    "{} invalid for non matching and not expired signature".format(
                        test_message_part
                    ),
                )
                ...
                self.assertFalse(
                    ...
                    "{} invalid for non matching and expired signature".format(
                        test_message_part
                    ),
                )
                with self.assertRaises(Exception) as e:
                    verify_notification_signature(
                        1, valid_response_timestamp, signature, valid_for
                    )
    ...
    def test_verify_notification_signature_sha256(self):
        with patch("time.time", return_value=MOCKED_NOW):
            with patch(
                "cloudinary.config",
                return_value=cloudinary.config(api_secret="someApiSecret"),
            ):
                self.assertTrue(
                    verify_notification_signature(
                        "{}",
    ...
    def test_api_sign_request_sha1(self):
        params = dict(
            cloud_name="dn6ot3ged", timestamp=1568810420, username="user@cloudinary.com"
        )
    ...
    def test_api_sign_request_sha256(self):
        ...
        signature = api_sign_request(
            params, "hdcixPpR2iKERPwqvH6sHdK9cyac", cloudinary.utils.SIGNATURE_SHA256
        )
