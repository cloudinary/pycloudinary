...
### Models
#### CloudinaryField
The `cloudinary.models.CloudinaryField` defines a field in the model that
represents an image stored in Cloudinary.
Allows you to store references to Cloudinary stored images in your model.
The internal type of the field is `CharField`.
...
#### Configuration
The size of the `CloudinaryField` can be set in the Django `setting.py` file:
