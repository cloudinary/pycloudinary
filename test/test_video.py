...
class VideoTest(unittest.TestCase):
    ...
    def test_video_thumbail(self):
        ...
        self.assertEqual(
            self.video.video_thumbnail(width=100), VIDEO_UPLOAD_PATH + "w_100/movie.jpg"
        )
    ...
    def test_video_image_tag(self):
        ...
        self.assertEqual(
            self.video.image(width=100), '<img src="' + expected_url + '" width="100"/>'
        )
    ...
    def test_video_tag_with_transformation(self):
        ...
        self.assertEqual(
            ...
            '<video height="100" poster="{expected_url}.jpg" src="{expected_url}.mp4" width="200"></video>'.format(
    ...
    def test_video_tag_with_fallback(self):
        ...
        self.assertEqual(
            self.video.video(fallback_content=fallback),
            '<video poster="'
            + expected_url
            + '.jpg">'
            + '<source src="'
        ...
        self.assertEqual(
            self.video.video(fallback_content=fallback, source_types="mp4"),
            '<video poster="'
            + expected_url
            + '.jpg" src="'
            + expected_url
    ...
    def test_video_tag_with_source_types(self):
        expected_url = VIDEO_UPLOAD_PATH + "movie"
        self.assertEqual(
            self.video.video(source_types=["ogv", "mp4"]),
            '<video poster="'
            + expected_url
            + '.jpg">'
            + '<source src="'
    ...
    def test_video_tag_with_poster(self):
        ...
        self.assertEqual(
            self.video.video(poster=expected_poster_url, source_types="mp4"),
            '<video poster="'
            + expected_poster_url
            + '" src="'
            + expected_url
        ...
        self.assertEqual(
            self.video.video(poster={"gravity": "north"}, source_types="mp4"),
            '<video poster="'
            + expected_poster_url
            + '" src="'
            + expected_url
        ...
        self.assertEqual(
            self.video.video(poster=None, source_types="mp4"),
            '<video src="' + expected_url + '.mp4"></video>',
        )

        self.assertEqual(
            self.video.video(poster=False, source_types="mp4"),
            '<video src="' + expected_url + '.mp4"></video>',
        )
    ...
    def test_video_tag_default_sources(self):
        ...
        self.assertEqual(
            '<video poster="'
            + expected_url.format("", "jpg")
            + '">'
            + '<source src="'
            + expected_url.format("vc_h265/", "mp4")
            + '" type="video/mp4; codecs=hev1">'
            + '<source src="'
            + expected_url.format("vc_vp9/", "webm")
            + '" type="video/webm; codecs=vp9">'
            + '<source src="'
            + expected_url.format("vc_auto/", "mp4")
            + '" type="video/mp4">'
            + '<source src="'
            + expected_url.format("vc_auto/", "webm")
            + '" type="video/webm">'
            + "</video>",
            self.video.video(
    ...
    def test_video_tag_sources_with_transformation(self):
        ...
        self.assertEqual(
            '<video height="100" poster="'
            + expected_url.format("vc_h264/", "jpg")
            + '" width="200">'
            + '<source src="'
            + expected_url.format("vc_h265/", "mp4")
            + '" type="video/mp4; codecs=hev1">'
